...
class ChallanApi {
  ...
  // -------------------------------------------------------------------------
  // GET DELIVERED CHALLAN NUMBERS BY CUSTOMER ID
  // -------------------------------------------------------------------------

  //   Future<List<String>> getDeliveredChallanNumbersByCustomerId(
  //   BuildContext context,
  //   int customerId,
  // ) async {
  //   if (customerId <= 0) {
  //     if (context.mounted) {
  //       showErrorToast(context, "Invalid customer ID");
  //     }
  //     return [];
  //   }
  ...
  //   final url = Uri.parse(
  //     '$normalizedBase/api/v1/challans/getCustomersChallanNumbers/$customerId',
  //   );
  ...
  //     // SUCCESS: 200 → Normal list
  //     if (response.statusCode == 200) {
  //       final List<dynamic> data = jsonDecode(response.body);
  //       return data.cast<String>();
  //     }

  //     // SPECIAL CASE: 404 with "fully returned" message → Show FRIENDLY toast
  //     if (response.statusCode == 404) {
  //       String message = "No pending challans found";
  ...
  //               backendMessage.toLowerCase().contains('fully returned')) {
  //             message = backendMessage; // Use exact backend message
  //           }
  //         } catch (_) {
  //           // ignore
  //         }
  ...
  //       // Show a NEUTRAL / INFO toast (not error!)
  //       if (context.mounted) {
  //         showSuccessToast(context, message); // Or use showSuccessToast with blue/green color
  //       }
  //       return [];
  //     }

  //     // ALL OTHER CASES → Real error
  //     final errorMessage = _extractErrorMessage(response);

  //     if (context.mounted) {
  //       showErrorToast(context, errorMessage);
  //     }
  //     debugPrint("getDeliveredChallanNumbers error: $errorMessage");
  //     return [];

  //   } on TimeoutException catch (_) {
  //     if (context.mounted) showErrorToast(context, "Request timed out");
  //     return [];
  //   } on http.ClientException catch (_) {
  //     if (context.mounted) showErrorToast(context, "No internet connection");
  //     return [];
  ...
  //     if (context.mounted) showErrorToast(context, "Something went wrong");
  //     return [];
  //   }
  // }
